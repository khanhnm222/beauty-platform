        ...
        <div className="lg:flex items-stretch md:mt-12 mt-8">
          <div className="lg:w-1/2">
            <div className="sm:flex items-center justify-between xl:gap-x-8 gap-x-6">
              <div className="sm:w-1/2 relative">
                ...
                <img src="./blog-4.jpg" className="w-full" alt="chair" />
              </div>
              <div className="sm:w-1/2 sm:mt-0 mt-4 relative">
                ...
                <img src="./blog-5.jpg" className="w-full" alt="wall design" />
              </div>
            </div>
            <div className="relative">
              ...
              <img src="./photo-vegetable-1.avif" alt="sitting place" className="w-full mt-8 md:mt-6 hidden sm:block" />
          ...
          <div className="lg:w-1/2 xl:ml-8 lg:ml-4 lg:mt-0 md:mt-6 mt-4 lg:flex flex-col justify-between">
            <div className="relative">
              ...
              <img src="./photo-vegetable.avif" alt="sitting place" className="w-full sm:block hidden" />
            ...
            <div className="sm:flex items-center justify-between xl:gap-x-8 gap-x-6 md:mt-6 mt-4">
              <div className="relative w-full">
                ...
                <img src="./blog-6.jpg" className="w-full" alt="chair" />
              </div>
