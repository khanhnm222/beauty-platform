...
const Banner = () => {
  ...
  return (
    <section className="w-full relative bg-[url(/belle-banner.png)] bg-cover bg-center bg-no-repeat">
      ...
      <div className={cn(
        "relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:items-center lg:px-8 flex items-end sm:pt-[15rem]", // lg:h-screen
        style.textContainer
      )}>
        <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
          <h1 className="text-3xl font-extrabold text-primary/80 sm:text-4xl">
            Let us find your
